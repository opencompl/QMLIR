...
parser = argparse.ArgumentParser(description='[QSSA] Tool to plot comparative circuit depths of optimized programs.')
...
for idx, kind in enumerate(['qiskit_lev1', 'qiskit_lev2', 'qssa']):
