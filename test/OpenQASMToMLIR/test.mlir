module {
  ...
  func @ch (%0 : !qasm.qubit, %1 : !qasm.qubit) -> () {
    ...
    std.call @cx(%0, %1) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%1) : (!qasm.qubit) -> ()
    std.call @t(%1) : (!qasm.qubit) -> ()
    std.call @cx(%0, %1) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @t(%1) : (!qasm.qubit) -> ()
    std.call @h(%1) : (!qasm.qubit) -> ()
    std.call @s(%1) : (!qasm.qubit) -> ()
    std.call @x(%1) : (!qasm.qubit) -> ()
    std.call @s(%0) : (!qasm.qubit) -> ()
    std.return 
  }
  func @ccx (%0 : !qasm.qubit, %1 : !qasm.qubit, %2 : !qasm.qubit) -> () {
    ...
    std.call @cx(%0, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @t(%2) : (!qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @tdg(%2) : (!qasm.qubit) -> ()
    std.call @cx(%0, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @t(%1) : (!qasm.qubit) -> ()
    ...
    std.call @h(%2) : (!qasm.qubit) -> ()
    std.call @cx(%0, %1) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @t(%0) : (!qasm.qubit) -> ()
    std.call @tdg(%1) : (!qasm.qubit) -> ()
    std.call @cx(%0, %1) : (!qasm.qubit, !qasm.qubit) -> ()
    std.return 
  }
  ...
  func @crx (%0 : f32, %1 : !qasm.qubit, %2 : !qasm.qubit) -> () {
    ...
    %5 = std.sitofp %4 : i32 to f32
    %6 = std.divf %3, %5 : f32
    std.call @u1(%6, %2) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %7 = std.negf %0 : f32
    %8 = std.constant 2 : i32
    %9 = std.sitofp %8 : i32 to f32
    ...
    std.call @u3(%10, %12, %14, %2) : (f32, f32, f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
  ...
  func @cry (%0 : f32, %1 : !qasm.qubit, %2 : !qasm.qubit) -> () {
    ...
    %9 = std.sitofp %8 : i32 to f32
    std.call @u3(%5, %7, %9, %2) : (f32, f32, f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %10 = std.negf %0 : f32
    ...
    std.call @u3(%13, %15, %17, %2) : (f32, f32, f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.return 
  }
  func @crz (%0 : f32, %1 : !qasm.qubit, %2 : !qasm.qubit) -> () {
    ...
    %4 = std.sitofp %3 : i32 to f32
    %5 = std.divf %0, %4 : f32
    std.call @u1(%5, %2) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %6 = std.negf %0 : f32
    %7 = std.constant 2 : i32
    %8 = std.sitofp %7 : i32 to f32
    %9 = std.divf %6, %8 : f32
    std.call @u1(%9, %2) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.return 
  }
  func @cu1 (%0 : f32, %1 : !qasm.qubit, %2 : !qasm.qubit) -> () {
    ...
    %4 = std.sitofp %3 : i32 to f32
    %5 = std.divf %0, %4 : f32
    std.call @u1(%5, %1) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %6 = std.negf %0 : f32
    %7 = std.constant 2 : i32
    %8 = std.sitofp %7 : i32 to f32
  ...
  func @cp (%0 : f32, %1 : !qasm.qubit, %2 : !qasm.qubit) -> () {
    ...
    %4 = std.sitofp %3 : i32 to f32
    %5 = std.divf %0, %4 : f32
    std.call @p(%5, %1) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %6 = std.negf %0 : f32
    %7 = std.constant 2 : i32
    %8 = std.sitofp %7 : i32 to f32
    %9 = std.divf %6, %8 : f32
    std.call @p(%9, %2) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %10 = std.constant 2 : i32
    %11 = std.sitofp %10 : i32 to f32
    %12 = std.divf %0, %11 : f32
  ...
  func @cu3 (%0 : f32, %1 : f32, %2 : f32, %3 : !qasm.qubit, %4 : !qasm.qubit) -> () {
    ...
    %7 = std.sitofp %6 : i32 to f32
    %8 = std.divf %5, %7 : f32
    std.call @u1(%8, %3) : (f32, !qasm.qubit) -> ()
    %9 = std.subf %2, %1 : f32
    %10 = std.constant 2 : i32
    %11 = std.sitofp %10 : i32 to f32
    %12 = std.divf %9, %11 : f32
    std.call @u1(%12, %4) : (f32, !qasm.qubit) -> ()
    std.call @cx(%3, %4) : (!qasm.qubit, !qasm.qubit) -> ()
    %13 = std.negf %0 : f32
    ...
    std.call @u3(%16, %18, %23, %4) : (f32, f32, f32, !qasm.qubit) -> ()
    std.call @cx(%3, %4) : (!qasm.qubit, !qasm.qubit) -> ()
  ...
  func @csx (%0 : !qasm.qubit, %1 : !qasm.qubit) -> () {
    ...
    %4 = std.sitofp %3 : i32 to f32
    %5 = std.divf %2, %4 : f32
    std.call @cu1(%5, %0, %1) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%1) : (!qasm.qubit) -> ()
    std.return 
  }
  func @cu (%0 : f32, %1 : f32, %2 : f32, %3 : f32, %4 : !qasm.qubit, %5 : !qasm.qubit) -> () {
    ...
    %8 = std.sitofp %7 : i32 to f32
    %9 = std.divf %6, %8 : f32
    std.call @p(%9, %4) : (f32, !qasm.qubit) -> ()
    %10 = std.subf %2, %1 : f32
    %11 = std.constant 2 : i32
    %12 = std.sitofp %11 : i32 to f32
    %13 = std.divf %10, %12 : f32
    std.call @p(%13, %5) : (f32, !qasm.qubit) -> ()
    std.call @cx(%4, %5) : (!qasm.qubit, !qasm.qubit) -> ()
    %14 = std.negf %0 : f32
    %15 = std.constant 2 : i32
    %16 = std.sitofp %15 : i32 to f32
    ...
    std.call @u(%17, %19, %24, %5) : (f32, f32, f32, !qasm.qubit) -> ()
    std.call @cx(%4, %5) : (!qasm.qubit, !qasm.qubit) -> ()
  ...
  func @rxx (%0 : f32, %1 : !qasm.qubit, %2 : !qasm.qubit) -> () {
    ...
    %8 = std.sitofp %7 : i32 to f32
    std.call @u3(%6, %0, %8, %1) : (f32, f32, f32, !qasm.qubit) -> ()
    std.call @h(%2) : (!qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %9 = std.negf %0 : f32
    std.call @u1(%9, %2) : (f32, !qasm.qubit) -> ()
  ...
  func @rccx (%0 : !qasm.qubit, %1 : !qasm.qubit, %2 : !qasm.qubit) -> () {
    ...
    %4 = std.sitofp %3 : i32 to f32
    %5 = qasm.pi : f32
    std.call @u2(%4, %5, %2) : (f32, f32, !qasm.qubit) -> ()
    %6 = qasm.pi : f32
    ...
    std.call @u1(%14, %2) : (f32, !qasm.qubit) -> ()
    std.call @cx(%0, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %15 = qasm.pi : f32
    %16 = std.constant 4 : i32
    %17 = std.sitofp %16 : i32 to f32
    %18 = std.divf %15, %17 : f32
    std.call @u1(%18, %2) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %19 = qasm.pi : f32
    %20 = std.negf %19 : f32
    ...
    %22 = std.sitofp %21 : i32 to f32
    %23 = std.divf %20, %22 : f32
    std.call @u1(%23, %2) : (f32, !qasm.qubit) -> ()
  ...
  func @rc3x (%0 : !qasm.qubit, %1 : !qasm.qubit, %2 : !qasm.qubit, %3 : !qasm.qubit) -> () {
    ...
    %5 = std.sitofp %4 : i32 to f32
    %6 = qasm.pi : f32
    std.call @u2(%5, %6, %3) : (f32, f32, !qasm.qubit) -> ()
    %7 = qasm.pi : f32
    %8 = std.constant 4 : i32
    %9 = std.sitofp %8 : i32 to f32
    %10 = std.divf %7, %9 : f32
    std.call @u1(%10, %3) : (f32, !qasm.qubit) -> ()
    std.call @cx(%2, %3) : (!qasm.qubit, !qasm.qubit) -> ()
    %11 = qasm.pi : f32
    %12 = std.negf %11 : f32
    %13 = std.constant 4 : i32
    %14 = std.sitofp %13 : i32 to f32
    %15 = std.divf %12, %14 : f32
    std.call @u1(%15, %3) : (f32, !qasm.qubit) -> ()
    %16 = std.constant 0 : i32
    %17 = std.sitofp %16 : i32 to f32
    %18 = qasm.pi : f32
    std.call @u2(%17, %18, %3) : (f32, f32, !qasm.qubit) -> ()
    std.call @cx(%0, %3) : (!qasm.qubit, !qasm.qubit) -> ()
    %19 = qasm.pi : f32
    %20 = std.constant 4 : i32
    %21 = std.sitofp %20 : i32 to f32
    %22 = std.divf %19, %21 : f32
    std.call @u1(%22, %3) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %3) : (!qasm.qubit, !qasm.qubit) -> ()
    %23 = qasm.pi : f32
    %24 = std.negf %23 : f32
    %25 = std.constant 4 : i32
    %26 = std.sitofp %25 : i32 to f32
    %27 = std.divf %24, %26 : f32
    std.call @u1(%27, %3) : (f32, !qasm.qubit) -> ()
    std.call @cx(%0, %3) : (!qasm.qubit, !qasm.qubit) -> ()
    %28 = qasm.pi : f32
    %29 = std.constant 4 : i32
    %30 = std.sitofp %29 : i32 to f32
    %31 = std.divf %28, %30 : f32
    std.call @u1(%31, %3) : (f32, !qasm.qubit) -> ()
    std.call @cx(%1, %3) : (!qasm.qubit, !qasm.qubit) -> ()
    %32 = qasm.pi : f32
    %33 = std.negf %32 : f32
    ...
    std.call @u1(%48, %3) : (f32, !qasm.qubit) -> ()
  ...
  func @c3x (%0 : !qasm.qubit, %1 : !qasm.qubit, %2 : !qasm.qubit, %3 : !qasm.qubit) -> () {
    ...
    %23 = std.sitofp %22 : i32 to f32
    %24 = std.divf %21, %23 : f32
    std.call @p(%24, %1) : (f32, !qasm.qubit) -> ()
    std.call @cx(%0, %1) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    %25 = qasm.pi : f32
    %26 = std.negf %25 : f32
    ...
    std.call @p(%38, %2) : (f32, !qasm.qubit) -> ()
    std.call @cx(%0, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @cx(%2, %3) : (!qasm.qubit, !qasm.qubit) -> ()
    %39 = qasm.pi : f32
    %40 = std.negf %39 : f32
    ...
    std.call @p(%70, %3) : (f32, !qasm.qubit) -> ()
    std.call @cx(%0, %3) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    std.return 
  }
  func @c3sqrtx (%0 : !qasm.qubit, %1 : !qasm.qubit, %2 : !qasm.qubit, %3 : !qasm.qubit) -> () {
    ...
    %7 = std.sitofp %6 : i32 to f32
    %8 = std.divf %5, %7 : f32
    std.call @cu1(%8, %0, %3) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    std.call @cx(%0, %1) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    %9 = qasm.pi : f32
    ...
    %11 = std.sitofp %10 : i32 to f32
    %12 = std.divf %9, %11 : f32
    std.call @cu1(%12, %1, %3) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    std.call @cx(%0, %1) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    %13 = qasm.pi : f32
    ...
    %16 = std.sitofp %15 : i32 to f32
    %17 = std.divf %14, %16 : f32
    std.call @cu1(%17, %1, %3) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    %18 = qasm.pi : f32
    ...
    std.call @cu1(%21, %2, %3) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    std.call @cx(%0, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    %22 = qasm.pi : f32
    ...
    std.call @cu1(%26, %2, %3) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    %27 = qasm.pi : f32
    ...
    std.call @cu1(%30, %2, %3) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    std.call @cx(%0, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    %31 = qasm.pi : f32
    ...
    std.call @cu1(%35, %2, %3) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%3) : (!qasm.qubit) -> ()
    std.return 
  }
  func @c4x (%0 : !qasm.qubit, %1 : !qasm.qubit, %2 : !qasm.qubit, %3 : !qasm.qubit, %4 : !qasm.qubit) -> () {
    ...
    %8 = std.sitofp %7 : i32 to f32
    %9 = std.divf %6, %8 : f32
    std.call @cu1(%9, %3, %4) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%4) : (!qasm.qubit) -> ()
    std.call @c3x(%0, %1, %2, %3) : (!qasm.qubit, !qasm.qubit, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%4) : (!qasm.qubit) -> ()
    %10 = qasm.pi : f32
    %11 = std.constant 2 : i32
    %12 = std.sitofp %11 : i32 to f32
    %13 = std.divf %10, %12 : f32
    std.call @cu1(%13, %3, %4) : (f32, !qasm.qubit, !qasm.qubit) -> ()
    std.call @h(%4) : (!qasm.qubit) -> ()
    std.call @c3x(%0, %1, %2, %3) : (!qasm.qubit, !qasm.qubit, !qasm.qubit, !qasm.qubit) -> ()
  ...
  func @qasm_main () -> () {
    ...
    std.call @cx(%1, %2) : (!qasm.qubit, !qasm.qubit) -> ()
    std.call @cx(%3, %1) : (!qasm.qubit, !qasm.qubit) -> ()
    std.return 
  }
}