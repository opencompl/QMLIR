...
module {
  ...
  func @static_argument_conversion(!quantum.qubit<10>)

  // CHECK: func @dynamic_argument_conversion(memref<?xi64>)
  func @dynamic_argument_conversion(!quantum.qubit<?>)

  // CHECK: func @static_result_conversion() -> memref<10xi64>
  func @static_result_conversion() -> !quantum.qubit<10>

  // CHECK: func @dynamic_result_conversion() -> memref<?xi64>
  func @dynamic_result_conversion() -> !quantum.qubit<?>
